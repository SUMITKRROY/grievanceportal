    ...
    child: Column(
      ...
      children: [
        ...
        CustomTextField(
          ...
          keyboardType: TextInputType.numberWithOptions(), validatorLable: 'Login Id ',
        ),
    ...
    :Column(
      children: [
        ...
        Row(
          ...
          children: [
            Text("Timer: 30"),
            InkWell(onTap: (){},child: Text("Resend OTP",style: TextStyle(color: Colors.blueAccent),),)
          ],
        ),
      ],
    ),
          ...
          child: Column(
            children: [
              ElevatedButton(  onPressed: () async {
                ...
                if (isValid) {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> Grievancescreen()));
                }
              ...
              InkWell(onTap: (){
                setState(
                  ...
                  child: Text("${onTap == true ? "or login" : "or get OTP"}")
              )
            ],
          ),
        )
